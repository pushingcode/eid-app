        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <span class="pl-4 self-center text-2xl font-semibold whitespace-nowrap hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                        {{ __('Vocational Center') }}
                    </span>
                </div>
                ...
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('eid') }}">
                                {{ __('Living Diagnosys') }}
                            </x-dropdown-link>
